...
export default function Home() {
    ...
    return (
        <div>
            {account ? (
                <div onClick={disconnect} className="cursor-pointer bg-[#fff091]  py-2 px-4 text-[#9c9259] transition duration-300 ease-in-out hover:bg-[#e3d681] hover:text-[#6b643d] rounded-2xl font-medium">
