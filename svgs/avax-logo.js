export default function AvaxSvg() {
    return (
        <svg width="25" height="25" aria-labelledby="titleID" style={{ marginRight: "6px" }}>
            <title id="titleID">Avalanche logo</title>
            <rect rx="6" fill="#F9F9F9" width="25" height="25"></rect>
            <rect rx="6" fill="#E8414233" width="25" height="25"></rect>
            <svg
                width="25"
                height="25"
                viewBox="0 0 24 24"
