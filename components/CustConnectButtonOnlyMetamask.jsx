...
export default function Home() {
    ...
    return (
        <div>
            {account ? (
                <div onClick={disconnect} className="cursor-pointer  bg-[#def2ff] hover:bg-[#c4e1f5] py-2 px-4 text-blue-400 transition duration-300 ease-in-out  hover:text-blue-600 rounded-2xl font-medium">
