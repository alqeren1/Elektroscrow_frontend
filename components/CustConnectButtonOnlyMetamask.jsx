...
export default function Home() {
    ...
    return (
        <div>
            {account ? (
                <div onClick={disconnect} className="cursor-pointer py-2 px-4 transition duration-300 ease-in-out bg-[#fff091]  text-[#9c9259] hover:bg-[#e3d681] hover:text-[#6b643d] rounded-2xl font-medium">
