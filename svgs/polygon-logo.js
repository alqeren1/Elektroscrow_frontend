export default function PolygonSvg() {
    return (
        <svg width="25" height="25" aria-labelledby="titleID" style={{ marginRight: "6px" }}>
            <title id="titleID">Polygon logo</title>
            <rect rx="6" fill="#F9F9F9" width="25" height="25"></rect>
            <rect rx="6" fill="#9558FF33" width="25" height="25"></rect>
            <svg
                width="25"
                height="25"
                viewBox="0 0 24 24"
